...
pub fn set_credentials(platform: &str, username: &str, password: &str) -> Result<()> {
    ...
    entry.set_password(password).context("monarch_credentials::set_credentials() Something went wrong while setting password! | Err: ")
}
...
pub fn get_password(platform: &str, username: &str) -> Result<String> {
    ...
    entry
        .get_password()
        .context("monarch_credentials::get_password() Could not get password! | Err: ")
}
...
pub fn delete_credentials(platform: &str, username: &str) -> Result<()> {
    ...
    entry.delete_password().context("monarch_credentials::delete_credentials() Something went wrong while deleting password from secure store! | Err: ")
}
